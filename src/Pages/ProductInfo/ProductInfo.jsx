          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-4">
              <div className="relative mb-4">
                <a
                  href={productData?.productImages?.[selectedImage]}
                  target="_blank"
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                />
                <div>
                  <div onClick={() => navigate(`/user/${productData?.seller?._id}`)} className="flex text-blue-700 underline cursor-pointer hover:scale-105 items-center space-x-2">
